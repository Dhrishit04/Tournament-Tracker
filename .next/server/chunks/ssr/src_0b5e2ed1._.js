        ...
        if (!initialized) {
            try {
                ...
                if (!firebaseApp) {
                    ...
                    auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$d5ff2369$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__o__as__getAuth$3e$__["getAuth"])(firebaseApp);
                }
                setInitialized(true);
            } catch (error) {
...
const AdminSignIn = ()=>{
    ...
    const { firebaseApp, auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFirebase"])();
    ...
    const handleSignIn = async (e)=>{
        ...
        try {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"])(auth, email, password);
            if (user) {
...
"[project]/src/app/admin-auth/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_0b5e2ed1._.js.map