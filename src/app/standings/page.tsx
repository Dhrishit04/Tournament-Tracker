...
export default function StandingsPage() {
    ...
    const standingsData = useMemo(() => {
        if (!teams || teams.length === 0) return { groups: {} as Record<string, Standing[]>, standalone: [] };
        ...
        if (isGroupMode) {
            ...
            return { groups: {} as Record<string, Standing[]>, standalone };
        }
    }, [teams, isGroupMode]);
        ...
        <div className="container mx-auto px-4 py-24 max-w-6xl relative z-10">
            ...
            {selectedTeam && (
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    <DialogContent className="bg-card/40 backdrop-blur-2xl border border-white/5 shadow-2xl sm:max-w-md">
                        <DialogHeader>
