...
import { PlusCircle, Edit, Trash2, LayoutGrid, Save, AlertCircle, RotateCcw, ArrowLeft } from 'lucide-react';
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <DialogFooter className="pt-4">
                    ...
                    <Button type="submit" className="hover-lift glow-purple bg-accent hover:bg-accent/90 text-accent-foreground">Save Team</Button>
                </DialogFooter>
            </form>
        </Form>
    );
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    <DialogContent className="w-[95vw] sm:max-w-2xl max-h-[92vh] flex flex-col p-0 overflow-hidden glass-card border-white/5">
                        ...
                        <DialogFooter className="p-6 pt-2 border-t border-white/5 mt-auto bg-background/50">
                            ...
                            <Button onClick={handleSaveGroups} className="hover-lift glow-purple bg-accent hover:bg-accent/90 h-10 text-[10px] font-black uppercase tracking-widest text-accent-foreground"><Save className="h-3 w-3 mr-2" /> Save All Assignments</Button>
                        </DialogFooter>
                    </DialogContent>
                </Dialog>
            </CardContent>
        ...
        <div className="space-y-6">
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
                    ...
                    <Button onClick={() => handleOpenDialog('add')} className="hover-lift glow-purple bg-accent hover:bg-accent/90 text-accent-foreground font-bold">
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {teams.map((team) => {
                                ...
                                return (
                                    <TableRow key={team.id} className="border-white/5 transition-all duration-300 hover:bg-accent/5 hover:shadow-[inset_2px_0_0_0_hsl(var(--accent))] relative group">
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent className="glass-card border-white/5">
                                                        ...
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction onClick={confirmDelete} className="hover-lift bg-destructive hover:bg-destructive/90 text-shadow-sm">Confirm Termination</AlertDialogAction>
                                                        </AlertDialogFooter>
                                                    </AlertDialogContent>
                                                </AlertDialog>
                                            </div>
