        ...
        <div className="space-y-6">
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <Button onClick={() => handleOpenDialog('add')} className="hover-lift glow-purple bg-accent hover:bg-accent/90 text-accent-foreground">
                                    ...
                                    <Table>
                                        ...
                                        <TableBody>
                                            {stageMatches.length > 0 ? stageMatches.map((match) => {
                                                ...
                                                return (
                                                    <TableRow key={match.id} className="border-white/5 transition-all duration-300 hover:bg-accent/5 hover:shadow-[inset_2px_0_0_0_hsl(var(--accent))] relative group">
                                                        ...
                                                        <TableCell>
                                                            {(match.status === 'FINISHED' || match.status === 'LIVE') ? (
                                                                <div className="flex items-center gap-2 font-mono font-black text-sm bg-black/40 px-2 py-0.5 rounded-md border border-white/10 w-fit shadow-[inset_0_0_10px_rgba(0,0,0,0.5)]">
                                                                ...
                                                                <span className="text-[10px] font-mono font-black opacity-20">—</span>
                                                            )}
                                                        </TableCell>
