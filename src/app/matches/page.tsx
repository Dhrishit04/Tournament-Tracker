...
const matches = [
  { id: 'm1', team1: 'T1', team2: 'T2', date: new Date(2024, 7, 15, 14, 0), score1: 2, score2: 1, status: 'Finished' },
  { id: 'm2', team1: 'T1', team2: 'T2', date: new Date(2024, 7, 15, 16, 0), status: 'Upcoming' },
  { id: 'm3', team1: 'T1', team2: 'T2', date: new Date(2024, 7, 17, 14, 0), status: 'Upcoming' },
  { id: 'm4', team1: 'T1', team2: 'T2', date: new Date(2024, 7, 17, 16, 0), score1: 0, score2: 0, status: 'Live' },
];
